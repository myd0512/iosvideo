...
+(void)indictorShow {
    ...
    pubV.frame = CGRectMake(0, kNavigationBarHeight, _window_width, _window_height-kNavigationBarHeight);
    BOOL have = NO;
...
+(void)showCenterGif:(UIView *)superView {
    ...
    _comment.frame = CGRectMake(0, _window_height-100-kNavigationBarHeight, _window_width, 100);
    UIImage *gifImg = [UIImage imageNamed:@""];
