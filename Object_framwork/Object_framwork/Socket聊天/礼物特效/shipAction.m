...
-(instancetype)initWithName:(NSString *)name and:(NSString *)icon{
    ...
    if (self) {
        ...
        imageV.frame = CGRectMake(50,30,WIDTH/1.5,WIDTH);
        ...
        btn.frame = CGRectMake(WIDTH*0.4,120, 40, 40);
        ...
        label.frame = CGRectMake(0,160,WIDTH,20);
        [imageV addSubview:label];
        
        [imageV addSubview:btn];

        //海洋
        imageVV = [[UIImageView alloc]initWithFrame:CGRectMake(-WIDTH,0,WIDTH*2,HEIGHT*0.6)];
        imageVV.contentMode = UIViewContentModeScaleAspectFit;
        imageVV.image = [UIImage imageNamed:@"yacht_water_one.png"];
        
        imageVVV = [[UIImageView alloc]initWithFrame:CGRectMake(0,0,WIDTH*2,HEIGHT*0.6)];
        imageVVV.contentMode = UIViewContentModeScaleAspectFit;
        imageVVV.image = [UIImage imageNamed:@"yacht_water_one.png"];
        
        myView = [[UIView alloc]initWithFrame:CGRectMake(0,HEIGHT*0.4,WIDTH,HEIGHT*0.6)];
...
-(void)donghua{
    ...
    NSValue *value2 = [NSValue valueWithCGRect:CGRectMake(WIDTH*0.3,yy,ww,ww)];
    
   // NSValue *value5 = [NSValue valueWithCGRect:CGRectMake(WIDTH*0.3,yy,w, w)];
    
    NSValue *value6 = [NSValue valueWithCGRect:CGRectMake(WIDTH*0.5,yy+30,w, w)];
    
    NSValue *value12 = [NSValue valueWithCGRect:CGRectMake(WIDTH*0.5,yy+10,w, w)];

    NSValue *value7 = [NSValue valueWithCGRect:CGRectMake(WIDTH*0.5,yy,w, w)];
    
    NSValue *value9 = [NSValue valueWithCGRect:CGRectMake(WIDTH*0.8,yy,w, w)];
    
    NSValue *value10 = [NSValue valueWithCGRect:CGRectMake(WIDTH*1.2,yy,w, w)];
    
    NSValue *value13 = [NSValue valueWithCGRect:CGRectMake(WIDTH*1.5,yy,w, w)];

    NSValue *value11 = [NSValue valueWithCGRect:CGRectMake(WIDTH*2,yy,w, w)];
...
-(void)timeII{
    [UIView animateWithDuration:10.0 animations:^{
        imageVVV.frame = CGRectMake(-WIDTH,0,WIDTH*2,HEIGHT*0.6);
        imageVV.frame = CGRectMake(0,0,WIDTH*2,HEIGHT*0.6);
