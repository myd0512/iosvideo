...
//    NSDictionary *levelDic = [common getUserLevelMessage:level];
    ...
    [contentStr addAttributes:@{NSForegroundColorAttributeName:oldNormalColors,NSFontAttributeName:[UIFont systemFontOfSize:14]} range:redRange];
...
//        make.top.equalTo(giftBGView).offset(-15);
    ...
    giftXL.labelTextColor = oldNormalColors;
...
//    labGiftNum.font = [UIFont fontWithName:@"Arial-BoldItalicMT" size:40];
    ...
    labGiftNum.labelTextColor = oldNormalColors;
