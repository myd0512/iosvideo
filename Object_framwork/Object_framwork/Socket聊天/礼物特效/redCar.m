...
#define carWidth  WIDTH/1.5
#define carHeight  HEIGHT/1.5
@interface redCar ()
{
...
-(instancetype)initWithIcons:(NSString *)icons andName:(NSString *)name{
    ...
    if (self) {
        ...
        */
        buttomView = [[UIView alloc]initWithFrame:CGRectMake(WIDTH,20,carWidth,carHeight)];
...
-(void)donghua{
    ...
    [UIView animateWithDuration:1.0 animations:^{
        buttomView.frame = CGRectMake(WIDTH/3,HEIGHT*0.1,carWidth,carHeight);
    }];
    ...
    dispatch_after(dispatch_time(DISPATCH_TIME_NOW, (int64_t)(1.9 * NSEC_PER_SEC)), dispatch_get_main_queue(), ^{
        ...
        [UIView animateWithDuration:2.5 animations:^{
            buttomView.frame = CGRectMake(-WIDTH,HEIGHT*0.15,carWidth,carHeight);
        }];
    });
    dispatch_after(dispatch_time(DISPATCH_TIME_NOW, (int64_t)(3.3 * NSEC_PER_SEC)), dispatch_get_main_queue(), ^{
        ...
        buttomView.frame = CGRectMake(WIDTH, HEIGHT*0.4, carWidth, carHeight);
        
        [UIView animateWithDuration:2.0 animations:^{
            buttomView.frame = CGRectMake(WIDTH/5,HEIGHT*0.2,carWidth,carHeight);
        }];
