...
{
    if (![[LocalizationManager bundle] localizedStringForKey:key value:@"" table:@"English"]) {
        return [[NSBundle mainBundle] localizedStringForKey:key value:@"" table:@"English"];
    }
    return [[LocalizationManager bundle] localizedStringForKey:key value:@"" table:@"English"];
}
...
//    FWQMUIBaseTabBarVC *tabbarVC = [[FWQMUIBaseTabBarVC alloc] init];
