...
- (SPPickerView *)pickerView {
    if (!_pickerView) {
		...
		[_pickerView sp_registerClass:[MyCell class] forComponent:1]; // 注册第1列cell
		[_pickerView sp_registerClass:[MyCell class] forComponent:2]; // 注册第1列cell
