...
-(UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath {
    ...
    FWQMUIPageMenuVC *controller = self.viewController.childViewControllers[indexPath.row];
    controller.view.frame = CGRectMake(0, 0, WIDTH, HEIGHT - 64.f - 50.f);
...
-(void)scrollViewDidScroll:(UIScrollView *)scrollView {
    if (self.scrollAction) {
        self.scrollAction(scrollView.contentOffset.x / WIDTH);
    }
}
