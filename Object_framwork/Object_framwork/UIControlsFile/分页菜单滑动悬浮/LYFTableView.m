...
-(void)setupTableView {
    ...
    self.rowHeight = HEIGHT - 64.f - 50.f;
...
#pragma mark - Set方法
-(void)setViewController:(FWQMUIPageMenuVC *)viewController {
...
-(UIView *)tableView:(UITableView *)tableView viewForHeaderInSection:(NSInteger)section {
    ...
    header.clickAction = ^(NSInteger index) {
        switch (index) {
            ...
            default: {
                [self.collectionView setContentOffset:CGPointMake(WIDTH, 0) animated:YES];
                break;
            }
        }
    };
...
-(LYFCollectionView *)collectionView {
    if (!_collectionView) {
        ...
        flowLayout.itemSize = CGSizeMake(WIDTH, HEIGHT - 64.f - 50.f);
        ...
        /// 64.f 是导航控制器的高度    50.f是列表的section头的高度
        _collectionView = [[LYFCollectionView alloc] initWithFrame:CGRectMake(0, 0, WIDTH, HEIGHT - 64 - 50.f) collectionViewLayout:flowLayout];
    }
