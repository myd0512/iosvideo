...
-(void)setUpBottomView{
    ...
    [cancelButton setTitleColor:UIColorGray1 forState:UIControlStateNormal];
    ...
    [commitButton setTitleColor:UIColorGray1 forState:UIControlStateNormal];
