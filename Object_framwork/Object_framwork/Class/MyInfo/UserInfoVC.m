...
-(void)initSubviews{
    ...
    [self getViewWith:@"登录账号" andSubString:@"" andisImg:NO andIsClick:NO andTag:2];
    [self getViewWith:@"昵称" andSubString:@"" andisImg:NO andIsClick:YES andTag:3];
    
    [QuickCreatUI creatUIViewWithSuperView:self.view andFrame:CGRectMake(0, top, WIDTH, 10) color:MainGray];
    top += 10 ;
    [self getViewWith:@"真实姓名" andSubString:@"" andisImg:NO andIsClick:YES andTag:4];
    [self getViewWith:@"联系电话" andSubString:@"" andisImg:NO andIsClick:YES andTag:5];
    [self getViewWith:@"微信" andSubString:@"" andisImg:NO andIsClick:NO andTag:6];
    [self getViewWith:@"QQ" andSubString:@"" andisImg:NO andIsClick:NO andTag:7];
    
    [QuickCreatUI creatUIViewWithSuperView:self.view andFrame:CGRectMake(0, top, WIDTH, 10) color:MainGray];
    top += 10 ;
    [self getViewWith:@"上次登录时间" andSubString:@"" andisImg:NO andIsClick:YES andTag:8];
    [self getViewWith:@"注册时间" andSubString:@"" andisImg:NO andIsClick:YES andTag:9];
