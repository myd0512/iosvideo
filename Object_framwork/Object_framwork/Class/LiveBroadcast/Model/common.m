...
NSString *const  letter_switch = @"letter_switch";
NSString *const  applets_switch = @"applets_switch";
...
+ (void)saveProfile:(liveCommon *)user
{
    ...
    [userDefaults setObject:user.letter_switch forKey:letter_switch];
    [userDefaults setObject:user.applets_switch forKey:applets_switch];
...
+ (void)clearProfile{
    ...
    [userDefaults setObject:nil forKey:letter_switch];
    [userDefaults setObject:nil forKey:applets_switch];
...
+ (liveCommon *)myProfile{
    ...
    user.letter_switch = [userDefaults objectForKey:letter_switch];
    user.applets_switch = [userDefaults objectForKey:applets_switch];
...
+(NSString *)letter_switch {
    NSUserDefaults *userDefaults = [NSUserDefaults standardUserDefaults];
    NSString *getStr = [userDefaults objectForKey:letter_switch];
    return getStr;
}
+(NSString *)applets_switch {
    NSUserDefaults *userDefaults = [NSUserDefaults standardUserDefaults];
    NSString *getStr = [userDefaults objectForKey:applets_switch];
    return getStr;
}
