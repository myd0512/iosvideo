...
-(void)setChatFrame:(chatModel *)upChat{
    UIFont *font1 = [UIFont systemFontOfSize:15];//Arial-ItalicMT
...
//    double suanheight = ceil(size.height);
    CGFloat widthhh = WIDTH*0.75 - 15 - (_liangR.size.width + _vipR.size.width + 6+16)-2;
    ...
    _NAMER = CGRectMake(2,3, WIDTH*0.75 - 15-4, suanheight);
