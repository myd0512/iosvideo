...
-(instancetype)initWithFrame:(CGRect)frame andhide:(minxinblock)hide andslider:(minxinblock)slider andtype:(minxinblock)type{
    ...
    if (self) {
           ...
           self.typeblocks = type;
            ...
            meiYanTuoDong = [[UISlider alloc] initWithFrame:CGRectMake(20, 45 *4 , WIDTH-40, 40)];
            ...
            meiyanSelectView = [[UIView alloc] initWithFrame:CGRectMake(0, HEIGHT/2, WIDTH, HEIGHT/2)];
            
            
            meiyanbtn1 = [[UIButton alloc] initWithFrame:CGRectMake(20, 0, WIDTH-40, 40)];
            [meiyanbtn1 setTitle:@"原始美白" forState:UIControlStateNormal];
            [meiyanbtn1 setTitle:@"原始美白(√)" forState:UIControlStateSelected];
            
            
            meiyanbtn2 = [[UIButton alloc] initWithFrame:CGRectMake(20, 45, WIDTH-40, 40)];
            [meiyanbtn2 setTitle:@"美颜" forState:UIControlStateNormal];
            [meiyanbtn2 setTitle:@"美颜(√)" forState:UIControlStateSelected];
            
            
            meiyanbtn3 = [[UIButton alloc] initWithFrame:CGRectMake(20, 45 *2 , WIDTH-40, 40)];
            [meiyanbtn3 setTitle:@"白皙" forState:UIControlStateNormal];
            [meiyanbtn3 setTitle:@"白皙(√)" forState:UIControlStateSelected];
            
            
            meiyanbtn4 = [[UIButton alloc] initWithFrame:CGRectMake(20, 45 *3 , WIDTH-40, 40)];
            [meiyanbtn4 setTitle:@"美颜+" forState:UIControlStateNormal];
            [meiyanbtn4 setTitle:@"美颜+(√)" forState:UIControlStateSelected];
            
            
            meiyanbtn5 = [[UIButton alloc] initWithFrame:CGRectMake(20, 45 *5 , WIDTH-40, 40)];
            [meiyanbtn5 setTitle:@"不使用美颜" forState:UIControlStateNormal];
            [meiyanbtn5 setTitle:@"不使用美颜+(√)" forState:UIControlStateSelected];
