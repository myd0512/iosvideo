...
-(void)laySubViews{
    ...
    UILabel * label1 = [ QuickCreatUI creatUILabelWithSuperView:self.contentView andFrame:CGRectMake(0, 0, 60, 20) andText:@"团队人数" andStringColor:threeBlaceFont andFont:12];
