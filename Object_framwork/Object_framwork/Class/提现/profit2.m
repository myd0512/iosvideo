...
- (void)viewDidLoad {
   ...
   // input.layer.cornerRadius = 20;
    ...
    tixian.backgroundColor = kRedColor;
...
-(void)tixian{
    ...
    NSString *url = [Base_URL stringByAppendingFormat:@"?service=User.userCash&uid=%@&token=%@&money=%@",[UserInfoManaget sharedInstance].model.id,[UserInfoManaget sharedInstance].model.token,input.text];
